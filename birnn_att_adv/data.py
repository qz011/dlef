...
def produce_data(readfilenames,savefilename):
    '''.txt files'''
    tr_x0, tr_x1, tr_y0  = read_data_xy(readfilename[0])
    va_x0, va_x1, va_y0  = read_data_xy(readfilename[1])
    te_x0, te_x1, te_y0  = read_data_xy(readfilename[2])


    data = ((tr_x0, tr_x1,  tr_y0),
            (va_x0, va_x1,  va_y0),
            (te_x0, te_x1,  te_y0))#tuple
...
if __name__ == '__main__':
    ...
    #data = read_data_xy("../train_idx.txt")
    #print(data[2])
